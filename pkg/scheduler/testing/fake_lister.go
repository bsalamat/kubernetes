...
type FakePriorityClassLister v1beta1.PriorityClass

// Get returns a PriorityClass by name.
func (f FakePriorityClassLister) Get(name string) (*v1beta1.PriorityClass, error) {
	pc := v1beta1.PriorityClass(f)
	return &pc, nil
}
