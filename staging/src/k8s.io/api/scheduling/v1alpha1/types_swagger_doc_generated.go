...
var map_PriorityClass = map[string]string{
	...
	"globalDefault": "GlobalDefault specifies whether this PriorityClass should be considered as the default priority for pods that do not have any priority class and their namespace do not have any other default priority.",
	"description":   "Description is an arbitrary string that usually provides guidelines on where this priority class should be used.",
}
